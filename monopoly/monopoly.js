...
function popup(HTML, action, option) {
	...
	document.getElementById("popup").style.borderColor = p.color
...
function updatePosition() {
	...
	for (var i = 0; i < 40; i++) {
		...
		if(i==1 || i==3)
			document.getElementById("cell" + i).style.border = "2px solid #8B4513";

		if(i==6 || i==8 || i==9)

			document.getElementById("cell" + i).style.border = "2px solid #87CEEB";

		if(i==11 || i==13 || i==14)
			document.getElementById("cell" + i).style.border = "2px solid #FF0080";

		if(i==16 || i==18 || i==19)
			document.getElementById("cell" + i).style.border = "2px solid #FFA500";

		if(i==21 || i==23 || i==24)
			document.getElementById("cell" + i).style.border = "2px solid #FF0000";

		if(i==26 || i==27 || i==29)
			document.getElementById("cell" + i).style.border = "2px solid #FFFF00";

		if(i==31 || i==32 || i==34)
			document.getElementById("cell" + i).style.border = "2px solid #008000";

		if(i==37 || i==39 )
			document.getElementById("cell" + i).style.border = "2px solid #0000FF";
